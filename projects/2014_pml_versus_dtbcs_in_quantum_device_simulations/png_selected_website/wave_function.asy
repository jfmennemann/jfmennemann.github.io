...
filename = "./data_selected/psi_dtbc_2nd_cn_t_2_5_ps.dat";
...
real r0 = 10.0;
draw(circle((0.5*L1_device,0.5*L2_device), r0), black+0.4);

path c1 = scale(1.5) * unitcircle;
fill(shift(0.5*L1_device,0.5*L2_device)*c1, black);

label("$\vec{B}$", (0.5*L1_device,0.5*L2_device), E+(3.5,0), black);
